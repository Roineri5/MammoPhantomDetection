...
and this model requires MATLAB run-time v23.2 (2023b) (https://www.mathworks.com/products/compiler/matlab-runtime.html)

For Mammography ACR phantom object detection model, input file format is *.png.
An input image of the phantom region should be cropped and three channels (RGB, not grayscale)

The software download link is below:
(https://drive.google.com/file/d/1K2gwliCzPtOR0yKRMbs69cLiqh4FnV8A/view?usp=sharing)


How to use: (The software is tested on Windows 10 only.)
1. Download and install the MATLAB run-time v23.2
